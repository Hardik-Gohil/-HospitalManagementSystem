								...
								<div class="row">
									<div class="col-lg-4">
										<fieldset class="form-group">
											...
											<form:input cssClass="form-control" id="username" path="username" disabled="${not empty userDto.username}" placeholder="Username"></form:input>
										</fieldset>
									</div>
									<div class="col-lg-4">
										<fieldset class="form-group">
											<label for="name">Name</label><span class="text-danger">*</span>
											<form:input cssClass="form-control" id="name" path="name" placeholder="Name"></form:input>
										</fieldset>
									</div>
									<div class="col-lg-4">
										<fieldset class="form-group">
											<label for="designation">Designation</label>
											<form:input cssClass="form-control" id="designation" placeholder="Designation" path="designation"></form:input>
										</fieldset>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-4">
										<fieldset class="form-group">
											...
											<form:input cssClass="form-control" id="employeeNumber" placeholder="Employee Number" path="employeeNumber"></form:input>
										</fieldset>
									</div>
									<div class="col-lg-4">
										<fieldset class="form-group">
											<label for="department">Department</label><span class="text-danger">*</span> 
											<form:select cssClass="form-control" id="department" path="department.departmentId" onchange="departmentChange();" disabled="${!isAdmin}">
									...
									<div class="col-lg-4">
										<fieldset class="form-group">
											...
											<form:input cssClass="form-control" id="emailId" placeholder="Email ID" path="emailId"></form:input>
										</fieldset>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-4">
										<fieldset class="form-group">
											...
											<form:input type="text" cssClass="form-control" id="mobileNumber" placeholder="Mobile Number" path="mobileNumber"></form:input>
										</fieldset>
									</div>
									<div class="col-lg-4" id="floorRow">
										<fieldset class="form-group">
											<label for="floor">Floor</label><span class="text-danger">*</span> 
											<form:select cssClass="form-control" id="floor" path="floor.floorId">
