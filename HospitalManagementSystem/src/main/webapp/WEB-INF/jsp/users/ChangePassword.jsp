								...
								<div class="row" id="oldPasswordRow">
									<div class="col-lg-4">
										<fieldset class="form-group">
											...
											<form:password cssClass="form-control" id="oldPassword" path="oldPassword" placeholder="Old Password"></form:password>
										</fieldset>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-4">
										<fieldset class="form-group">
											...
											<form:password cssClass="form-control" id="password" path="password" placeholder="Password"></form:password>
										</fieldset>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-4">
										<fieldset class="form-group">
											...
											<form:password cssClass="form-control" id="confirmPassword" path="confirmPassword" placeholder="Confirm Password"></form:password>
										</fieldset>
									</div>
								</div>
